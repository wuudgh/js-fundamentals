...
// Concatenate firstName and secondName
const fullName = null

// Get the 10th character of the alphabet variable
const tenthCharacterOfAlphabet = null

// Call a method on the alphabet variable to transform it to lower case
const lowerCaseAlphabet = null

// Use a property on the alphabet variable to get it's length
